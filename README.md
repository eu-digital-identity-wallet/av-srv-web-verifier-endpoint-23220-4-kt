...
**Important!** Before you proceed, please be aware that this Git repository is a copy of the Verifier Backend from the EUDI Wallet Reference Project, which is publicly available at https://github.com/eu-digital-identity-wallet/eudi-srv-web-verifier-endpoint-23220-4-kt
.
It has been extended to include a new trusted list format specifically designed for age verification purposes.
This repository will be archived once the corresponding functionality becomes available in the official EUDI Wallet Reference Project.
